...
ApplicationUI::ApplicationUI() :
        QObject()
{
    qmlRegisterType < AppInfo > ("anpho.appinfo", 1, 0, "AppInfo");
...
void ApplicationUI::onSystemLanguageChanged()
{
    ...
    QString file_name = QString("Moment_%1").arg(locale_string);
...
void ApplicationUI::setTheme(QString value)
{
    AppSettings::saveValueFor("theme", value);
}
QString ApplicationUI::getTheme(QString def)
{
    return AppSettings::getValueFor("theme", def);
}
